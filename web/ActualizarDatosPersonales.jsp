...
<html>
    ...
    <body class="is-preload">
        <header id="header" style="">
            ...
            <a class="logo center-align textgrueso " id="ulUserData"style="padding-top:6px; text-align:center; width:100%; font-size:20px; color:#ffffff" href="index.html">Actualizar Datos Personales</a>
        </header>
         <form class="col s12">
            <div class="row">
    ...
    <center>
        <button onclick="Actualizar()">Enviar</button><br><br>
        </center>
